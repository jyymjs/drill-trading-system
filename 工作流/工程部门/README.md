...
**框架入口**：[`CLAUDE.md`](CLAUDE.md)（四个角色/核心原则/使用方式/助理中转——以它为准）
**角色定义**：`规划/执行/测试/内审/`（planner/executor/reviewer/optimizer + 共享的 `_organization.md`）
...
├── 规划/执行/测试/内审/              # 四个角色的定义文件 + _organization.md（组织架构单一来源）
